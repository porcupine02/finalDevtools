  ...
  methods: {
    async fetchBills() {
      try {
        ...
        const response = await axios.get("http://34.125.112.174:3001/bills");
    ...
    async fetchMember() {
      try {
        console.log("fetch bills");
        const response = await axios.get("http://34.125.112.174:3001/memberBill");
    ...
    cal() {
      ...
      axios
        .post("http://34.125.112.174:3001/bills", { bills: this.bills })
        .then((response) => {
    ...
    addMember() {
      ...
      if (this.newMember != "") {
        ...
        axios
          .post("http://34.125.112.174:3001/memberBill", { member: this.newMember })
          .then((response) => {
            console.log("POST request successful:", response.data);
            this.fetchMember();
          })
    ...
    addMenu() {
      ...
      axios
        .post("http://34.125.112.174:3001/bills", { bills: this.listMenu })
        .then((response) => {
          console.log("POST request successful:", response.data);
          this.fetchBills();
        })
    ...
    deletePerson(index) {
      ...
      axios
        .delete(`http://34.125.112.174:3001/memberBill/${memberID}`)
        .then((response) => {
          console.log("POST request successful:", response.data);
          this.fetchMember();
    ...
    deleteListMenu(index) {
      ...
      axios
        .delete(`http://34.125.112.174:3001/bill/${this.bills[index].id}`)
        .then((response) => {
          console.log("POST request successful:", response.data);
          this.newListMenu = "";
          this.price = 0;
